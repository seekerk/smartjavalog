//------------ $PROPERTY_NAME$ --------------
    ...
    public ArrayList<$PROPERTY_TYPE$> $PROPERTY_NAME$() {
        ...
        return get$PROPERTY_TYPE$InTriples($PROPERTY_NAME$_URI);
    }

    public void $PROPERTY_NAME$($PROPERTY_TYPE$ value) {
        $PROPERTY_NAME$(value, true);
    }
    
    public void $PROPERTY_NAME$(ArrayList<$PROPERTY_TYPE$> value) {
        $PROPERTY_NAME$(value, true);
    }
    ...
    public void $PROPERTY_NAME$(ArrayList<$PROPERTY_TYPE$> value, boolean removeOldValues) {
        if (_$PROPERTY_NAME$_new == null) {
            _$PROPERTY_NAME$_new = $PROPERTY_NAME$();
        }
        if (removeOldValues) {
        ...
        _$PROPERTY_NAME$_new.addAll(value);
    }
//============== $PROPERTY_NAME$ =============
